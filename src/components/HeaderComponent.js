        ...
        <Navbar className="header-nav" expand="lg" dark>
          <div className="container-fluid">
            ...
            <NavLink className="nav-link" to="/home">
              <NavbarBrand href="/" className="website-name">
                <h1>Mantis Place</h1>
              </NavbarBrand>
            </NavLink>
            ...
            <NavbarToggler
              className="toggler order-first align-items-center"
            ...
            >
              {" "}
              {/*must write so isOpen applies only to smaller breakpoint */}
              <Nav className="mr-auto" navbar>
                ...
                <NavItem>
                  <NavLink className="d-lg-none nav-link" to="/home">
                    Care Sheets
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink className="nav-link" to="/mantises">
                    Mantises
                  </NavLink>
                </NavItem>
                <NavItem>
        ...
        >
          ...
          <ModalFooter>
            <Col className="p-0 text-left">
              <Button
                color="success"
                className="p-2 rounded-0 product-button text-left"
                aria-label="Checkout"
              >
                Checkout
              </Button>
